...
if __name__ == '__main__':
  # rm_percentages = [0.6, 0.45, 0.3, 0.15, 0]
  rm_percentages = [0.525, 0.375, 0.225, 0.075]
  ...
  # with open('../experiments/remove_unforggetable_examples_mnist/rm_accuracies1.csv', 'w') as f:
  with open('../experiments/remove_unforggetable_examples_mnist/rm_accuracies2.csv', 'w') as f:
